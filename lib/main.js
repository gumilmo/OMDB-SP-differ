...
const sourceFileJSdom = new jsdom_1.JSDOM(loadFile('././test-pages/2-src.html').toString());
const destFileJSdom = new jsdom_1.JSDOM(loadFile('././test-pages/2-dst.html').toString());
