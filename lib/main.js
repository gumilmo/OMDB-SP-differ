...
const source = new comparable_document_model_1.ComparableDocument(loadFile("C://old.html").toString().split('\n').map((line, index) => new line_model_1.Line(line.replace('\r', ''), index + 1)));
const dest = new comparable_document_model_1.ComparableDocument(loadFile("C://new.html").toString().split('\n').map((line, index) => new line_model_1.Line(line.replace('\r', ''), index + 1)));
